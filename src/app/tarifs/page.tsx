...
const PLANS = [
  {
    ...
    features: [
      ...
      'Génération IA (3 calculs par mois)',
      'Base de prix FranceAgriMer',
      'Accès aux évolutions de prix du marché',
    ],
    missing: [
      'Plats illimités',
      'Export PDF fiche technique',
      'Analyse de carte + scan IA',
  ...
  },
  {
    ...
    features: [
      ...
      'Scan IA de carte restaurant',
      'Menu engineering (matrice popularité/rentabilité)',
      'Prix fournisseurs personnalisés',
      'Évolution des prix du marché (hausse/baisse)',
      'Base de prix FranceAgriMer',
    ],
    missing: [],
