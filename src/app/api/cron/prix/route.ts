...
const PREVIOUS_WEEK_REF: Record<string, number> = {
  ...
  'Agneau - Gigot entier': 15.50, 'Agneau - Épaule': 12.20, 'Agneau - Rack / carré': 29.00,
  'Agneau - Côtelette': 22.50, 'Agneau - Souris': 16.50, 'Agneau - Selle': 24.50,
  'Porc - Filet mignon': 14.20, 'Porc - Côte': 10.20, 'Porc - Travers': 8.80,
  'Porc - Ventre': 6.50, 'Porc - Joue': 8.20,
  ...
  'Sole - Filet': 43.00, 'Turbot - Filet': 56.00, 'Saint-Pierre - Entier': 18.50,
  'Bar - Filet': 29.00, 'Bar - Entier': 18.50, 'Daurade - Filet': 22.50,
  'Daurade - Entière': 14.50, 'Lotte - Queue': 23.00, 'Rouget - Filet': 33.00,
  'Thon rouge - Pavé': 36.00, 'Saumon - Filet': 18.50, 'Saumon - Pavé': 20.50,
  'Truite - Filet': 14.50, 'Cabillaud - Filet': 15.50, 'Cabillaud - Dos': 23.00,
  'Lieu noir - Filet': 12.50, 'Maquereau - Filet': 8.50, 'Sardine - Fraîche': 5.20,
  'Anchois frais': 8.50, 'Merlu - Filet': 14.50,
  'Homard breton - Entier': 58.00, 'Langoustines': 45.00, 'Gambas - Entières': 29.00,
  'Crevettes roses décortiquées': 22.50, 'Crevettes grises': 18.50,
  'Saint-Jacques - Noix': 40.00, 'Moules de bouchot': 3.60, 'Huîtres creuses': 8.20, 'Palourdes': 14.50,
  'Asperge verte': 10.50, 'Asperge blanche': 12.00, 'Petits pois frais': 5.50,
  ...
  'Fraise Gariguette': 12.00, 'Citron jaune': 2.10, 'Orange': 1.90, 'Mangue': 4.20, 'Avocat': 3.60,
  'Beurre doux': 9.20, 'Crème liquide 35% MG': 5.20, 'Crème fraîche épaisse': 4.60,
  'Lait entier': 1.25, 'Parmesan - Reggiano': 24.50, 'Comté 18 mois': 18.50,
  'Mozzarella di bufala': 14.50, 'Huile d\'olive vierge extra': 9.20, 'Farine T45': 1.25,
